    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Bouton Discord — Wanted Poster style */}
          <button
            onClick={signIn}
            style={{
              ...
              boxShadow: '0 0 40px rgba(255,215,0,0.12), inset 0 1px 0 rgba(255,255,255,0.05)',
              transition: 'all .2s',
              position: 'relative', overflow: 'hidden',
            }}
            onMouseEnter={e => {
              e.currentTarget.style.transform = 'translateY(-3px)'
              e.currentTarget.style.boxShadow = '0 8px 40px rgba(255,215,0,0.25), inset 0 1px 0 rgba(255,255,255,0.1)'
              e.currentTarget.style.borderColor = 'rgba(255,215,0,0.8)'
            }}
            onMouseLeave={e => {
              e.currentTarget.style.transform = 'translateY(0)'
              e.currentTarget.style.boxShadow = '0 0 40px rgba(255,215,0,0.12), inset 0 1px 0 rgba(255,255,255,0.05)'
          ...
          >
            ...
            <span>Embarquer avec Discord</span>
          </button>
