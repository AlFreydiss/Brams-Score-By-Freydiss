...
const MYSTERIES = [
  {
    ...
    theories: ['Un héritage de Joy Boy et du Siècle du Vide', 'La vérité sur l\'histoire du monde effacée par le Gouvernement', 'Peut-être pas un objet physique mais une connaissance ou une clé'],
    status: 'Non résolu',
  },
  {
    emoji: '🌑',
    title: 'Le Siècle du Vide',
    color: '#a29bfe',
    level: 'MAJEUR',
  ...
  },
  {
    ...
    color: '#fdcb6e',
    level: 'MAJEUR',
    desc: 'Personnage mythique du Siècle du Vide ayant laissé des excuses gravées sur le Ponéglyphe de Fishman Island. Il avait fait une promesse qu\'il n\'a pas pu tenir. Zounisha affirme attendre le retour de son héritier depuis 800 ans. Luffy est confirmé comme ce successeur lors de l\'éveil de son fruit en Gear 5.',
  ...
  },
  {
    ...
    theories: ['Le fruit choisit lui-même son porteur — il a "fui" le Gouvernement pendant 800 ans', 'Le rire de Luffy (Ha Ha Ha) est identique à celui de Roger et de Nika', 'Nika est une figure mythique qui a libéré des esclaves dans le Siècle du Vide'],
  ...
  },
  {
    ...
    theories: ['Imu est immortel depuis le Siècle du Vide — peut-être via l\'Ope Ope no Mi', 'Imu est directement lié à Joy Boy — soit son ennemi, soit quelqu\'un qui lui a survécu', 'Imu pourrait être une femme (certaines cases le suggèrent)'],
  ...
  },
  {
    ...
    color: '#00b894',
    level: 'MAJEUR',
    desc: 'L\'histoire complète du Siècle du Vide est fragmentée en 4 Ponéglyphes "Rio" dispersés dans le monde. Roger était la seule personne à pouvoir les "entendre" sans les lire. Nico Robin a pour destin de les lire et de révéler cette vérité au monde entier — c\'est pourquoi le Gouvernement la traque depuis son enfance.',
    theories: ['Les 4 Ponéglyphes révèlent la localisation de Laugh Tale combinés', 'La vérité du Siècle du Vide renverserait le Gouvernement Mondial', 'Roger a pleuré en comprenant qu\'il était né trop tôt pour accomplir la promesse de Joy Boy'],
  ...
  },
  {
    ...
    theories: ['Le "D" signifie "Dawn" (Aube) — les porteurs apporteront l\'aube au monde', 'Ils sont les descendants de l\'ancien royaume vaincu lors du Siècle du Vide', 'Chaque "D" porte inconsciemment la volonté de Joy Boy et se bat pour la liberté'],
