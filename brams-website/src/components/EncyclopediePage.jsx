...
const FRUITS = [
  ...
  { name: 'Hana Hana no Mi', type: 'Paramecia', user: 'Nico Robin', color: '#fd79a8', emoji: '🌸', power: "Fait pousser des répliques de membres sur n'importe quelle surface.", rare: false, image: null },
  ...
  { name: 'Magu Magu no Mi', type: 'Logia', user: 'Akainu', color: '#d63031', emoji: '🌋', power: "Magma brûlant tout, même le feu. Température la plus haute parmi les Logia.", rare: true, image: null },
  { name: 'Suke Suke no Mi', type: 'Paramecia', user: 'Absalom / Shiryu', color: '#81ecec', emoji: '👻', power: "Invisibilité totale de soi-même et de tout ce qu'on touche.", rare: false, image: null },
  ...
  { name: 'Zoan Uo Uo no Mi', type: 'Zoan', user: 'Kaidou', color: '#8e44ad', emoji: '🐉', power: "Transformation en dragon oriental gigantesque. Maîtrise totale des éléments.", rare: true, image: null },
  { name: 'Tori Tori no Mi (Phénix)', type: 'Zoan', user: 'Marco', color: '#0984e3', emoji: '🔵', power: "Transformation en phénix légendaire. Flammes bleues de régénération.", rare: true, image: null },
