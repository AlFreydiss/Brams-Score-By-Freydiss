...
// DA : laiton désaturé chaud (#81b64c), distincte de l'univers Dames (bleu-acier froid).
...
export const CHESS_ACCENT = '#81b64c'
export const CHESS_BG = '#17181c'
const ORDER = ['jouer', 'regles', 'apprendre', 'classement', 'parametres']
