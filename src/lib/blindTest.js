...
export const LOCAL_TRACKS = [
  ...
  },
  {
    ...
    type:       'OP',
    episode:    'Opening 2',
    url:        '/blind-test/fsn-ubw-op2.mp4',
    difficulty: 'difficile',
    color:      '#c0a060',
    emoji:      '✨',
