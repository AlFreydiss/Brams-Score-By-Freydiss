...
import VIDEOS_RAW from '../data/domestic-na-kanojo-videos.json'
  ...
  return (
    <aside style={{
      ...
      <div style={{ position:'relative', height:260, overflow:'hidden', flexShrink:0 }}>
        <img
          src={COVER} alt="Domestic na Kanojo"
...
export default function DomesticNaKanojoPage({ onClose }) {
        ...
        <div style={{
          ...
          <div style={{ position:'absolute',left:'50%',transform:'translateX(-50%)',display:'flex',alignItems:'center',gap:10 }}>
            ...
            <span style={{ fontFamily:"'Pirata One',cursive",fontSize:17,fontWeight:900,color:'#fff',letterSpacing:'-.01em' }}>
              {playerIdx !== null ? (VIDEOS[playerIdx]?.title || `Épisode ${VIDEOS[playerIdx]?.episode}`) : "Domestic na Kanojo"}
            </span>
          </div>
        ...
        {playerIdx !== null ? (
          ...
          <div ref={scrollRef} className="vy-scroll" style={{ flex:1,overflowY:'auto',padding:'24px 28px 48px' }}>
            ...
            <div className="vy-layout">
              ...
              <div>
                {detailIdx !== null && (
                  <EpisodeDetailInline video={VIDEOS[detailIdx]} ns={NS} animeTitle="Domestic na Kanojo" color={COLOR} color2={COLOR2} onPlay={() => openPlayer(detailIdx)} onClose={() => setDetailIdx(null)} />
                )}
