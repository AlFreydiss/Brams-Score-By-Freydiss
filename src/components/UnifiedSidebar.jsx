  ...
  return (
    <>
      <style>{`
        ...
        .hub-event-body { flex:1; min-width:0; }
        .hub-event-title { font-size:12.5px; font-weight:700; color:rgba(255,255,255,.9); margin-bottom:4px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
