...
const COLOR  = '#60a5fa'
const COLOR2 = '#bfdbfe'
const NS     = 'koi-ameagari'

const SYNOPSIS = "Après une blessure qui a brisé son rêve d'athlétisme, Akira, 17 ans, tombe amoureuse de Kondô, le gérant quadragénaire du restaurant où elle travaille. Une histoire douce-amère sur les rêves, le temps qui passe et les sentiments inattendus."
    ...
    <aside style={{
      ...
      <div style={{ position:'relative', height:260, overflow:'hidden', flexShrink:0 }}>
        <img loading="lazy" decoding="async"
          src={COVER} alt="Koi wa Ameagari no You ni"
...
export default function KoiAmeagariPage({ onClose }) {
              ...
              <div>
                ...
                <div style={{ marginTop:28,padding:'14px 18px',borderRadius:12,background:'rgba(255,255,255,.03)',border:'1px solid rgba(255,255,255,.05)',display:'flex',alignItems:'center',gap:10 }}>
                  ...
                  <span style={{ fontSize:12,color:'rgba(255,255,255,.38)',fontWeight:600,lineHeight:1.5 }}>
                    Koi wa Ameagari no You ni (2018) — un drame romantique adapté du manga de Jun Mayuzuki.</span>
                </div>
