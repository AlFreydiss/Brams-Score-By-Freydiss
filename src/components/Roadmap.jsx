...
const ITEMS = [
  ...
  { status: 'done', date: 'Avr 2025', title: 'Quiz Animé IA', desc: 'Questions sur One Piece. Classement et récompenses.', icon: '🧠' },
  { status: 'done', date: 'Mai 2025', title: 'Site Brams Community', desc: 'Ce site ! Classement en temps réel, IA intégrée, design One Piece complet.', icon: '🌐' },
