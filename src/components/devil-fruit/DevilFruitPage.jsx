...
import {
  Search, Grid2X2, List, LayoutGrid, Crown, Sparkles,
  Lock, Wind, Zap, Layers, ArrowUpDown, FolderOpen,
  Star, X, EyeOff, Eye, Anchor, PawPrint,
} from 'lucide-react'

// ─── PALETTE ─────────────────────────────────────────────────────────────────
const C = { void:'#030303', abyss:'#0A0A0A', red:'#9F1239', gold:'#EAB308', text:'#E0E0E0' }
...
const TM = {
  'Logia':    { color:'#3B82F6', glow:'rgba(59,130,246,0.35)' },
  'Paramecia':{ color:'#10B981', glow:'rgba(16,185,129,0.35)' },
  'Zoan':     { color:'#F97316', glow:'rgba(249,115,22,0.35)' },
  '???':      { color:'#9F1239', glow:'rgba(159,18,57,0.4)'   },
}
...
const FRUITS = [
  ...
  { id:1,  name:'Magu Magu no Mi',         type:'Logia',    rarity:'legendaire', user:'Sakazuki — Akainu',       emoji:'🌋', power:97, colors:['#7f1d1d','#450a0a'], classified:false, spoiler:false,
    desc:"Le fruit le plus offensif des Logia. Le magma incandescent dépasse même les flammes.",
    tags:['Offensif','Amiral','Marine'],
    lore:"Sakazuki, Amiral en Chef de la Marine, a tué Portgas D. Ace d'un seul coup de magma. Ses flammes atteignent 1 200°C et consumment le feu lui-même. Son principe absolu : l'Élimination totale." },
  { id:2,  name:'Hie Hie no Mi',           type:'Logia',    rarity:'legendaire', user:'Kuzan — Aokiji',          emoji:'🧊', power:93, colors:['#0c4a6e','#0f172a'], classified:false, spoiler:false,
    desc:"Transforme en glace pure. Capable de geler des mers entières en quelques secondes.",
    tags:['Contrôle','Zone','Ancien Amiral'],
  ...
  { id:3,  name:'Goro Goro no Mi',         type:'Logia',    rarity:'legendaire', user:'Enel',                    emoji:'⚡', power:91, colors:['#713f12','#422006'], classified:false, spoiler:false,
    desc:"Maîtrise absolue de la foudre. Enel se proclamait dieu de Skypiea.",
    tags:['Vitesse','Omniscience','Skypiea'],
    lore:"Enel pouvait lire les ondes électriques dans un rayon de 6 400 km. Sa défaite contre Luffy — corps en caoutchouc naturellement résistant à l'électricité — reste l'une des surprises les plus mémorables." },
  { id:4,  name:'Mera Mera no Mi',         type:'Logia',    rarity:'legendaire', user:'Portgas D. Ace → Sabo',   emoji:'🔥', power:89, colors:['#7c2d12','#431407'], classified:false, spoiler:false,
    desc:"Maîtrise du feu. Flammes vives capables de consumer presque tout.",
    tags:['Feu','Révolutionnaire','Héritage'],
    lore:"Fruit originel d'Ace, fils du Roi des Pirates. Passé à Sabo lors du tournoi de Dressrosa. Sa flamme bleue «Hiken» est devenue le symbole de la fraternité des frères." },
  { id:5,  name:'Pika Pika no Mi',         type:'Logia',    rarity:'legendaire', user:'Borsalino — Kizaru',      emoji:'☀️', power:95, colors:['#78350f','#451a03'], classified:false, spoiler:false,
    desc:"Transforme en lumière pure. Vitesse absolue — 300 000 km/s.",
    tags:['Vitesse Lumière','Amiral','Laser'],
    lore:"Kizaru se déplace à la vitesse de la lumière. Ses lasers traversent les navires de guerre. L'un des obstacles les plus redoutables jamais affrontés par les Chapeaux de Paille à Sabaody." },
  { id:6,  name:'Suna Suna no Mi',         type:'Logia',    rarity:'legendaire', user:'Crocodile',               emoji:'🏜️', power:86, colors:['#78350f','#451a03'], classified:false, spoiler:false,
    desc:"Maîtrise du sable sec. Déshydrate tout être vivant d'un simple contact.",
    tags:['Déshydratation','Shichibukai','Alabasta'],
    lore:"Ancien Warlord, chef de Baroque Works. A failli détruire le Royaume d'Alabasta. Vaincu deux fois par Luffy grâce à une solution simple : le sang et l'eau de mer." },
  // PARAMECIA
  { id:7,  name:'Ope Ope no Mi',           type:'Paramecia',rarity:'legendaire', user:'Trafalgar D. Law',        emoji:'🏥', power:94, colors:['#14532d','#052e16'], classified:false, spoiler:false,
    desc:"Crée une Salle d'Opération sphérique. Le fruit le plus précieux au monde.",
    tags:['Médecin','ROOM','Immortalité'],
    lore:"Peut conférer l'immortalité — au prix de la vie de l'utilisateur. Law l'a reçu de Corazón pour guérir la maladie de Flevance. Son Awaken lui donne un contrôle absolu sur l'espace." },
  { id:8,  name:'Gura Gura no Mi',         type:'Paramecia',rarity:'legendaire', user:'Barbe Blanche → Barbe Noire',emoji:'🌊',power:99, colors:['#1e3a5f','#0f2040'], classified:false, spoiler:false,
    desc:"Crée des tremblements dans l'air et la mer. Capable de détruire le monde.",
    tags:['Destruction','Yonko','Séisme'],
    lore:"Barbe Blanche causait des tsunamis géants. À sa mort, Barbe Noire a absorbé son pouvoir — possédant ainsi deux fruits simultanément, défi absolu à toutes les lois connues." },
  { id:9,  name:'Ito Ito no Mi',           type:'Paramecia',rarity:'legendaire', user:'Donquixote Doflamingo',   emoji:'🕸️', power:88, colors:['#4a044e','#2d0030'], classified:false, spoiler:false,
    desc:"Génère des fils tranchant l'acier et contrôlant les gens comme des marionnettes.",
    tags:['Marionnettiste','Shichibukai','Dressrosa'],
    lore:"Doflamingo a tissé sa toile sur Dressrosa pendant des décennies. En Awaken, ses fils peuvent couvrir des îles entières — transformant tout ce qu'ils touchent en fils tranchants." },
  { id:10, name:'Hana Hana no Mi',         type:'Paramecia',rarity:'rare',       user:'Nico Robin',              emoji:'🌸', power:78, colors:['#831843','#500724'], classified:false, spoiler:false,
    desc:"Fait éclore des copies de ses membres corporels sur n'importe quelle surface.",
    tags:['Archéologue','Ponéglyphes','Ohara'],
    lore:"Seule survivante d'Ohara, Robin peut faire apparaître ses membres partout à portée. Son Awaken crée des membres géants. Elle est la seule personne capable de lire les Ponéglyphes." },
  { id:11, name:'Bara Bara no Mi',         type:'Paramecia',rarity:'commun',     user:'Buggy le Clown',          emoji:'🤡', power:45, colors:['#7f1d1d','#450a0a'], classified:false, spoiler:false,
    desc:"Sépare le corps en morceaux indépendants flottants. Immunise contre les attaques tranchantes.",
    tags:['Comique','Buggy Pirates','Impel Down'],
    lore:"Fruit avalé accidentellement lors d'une tentative de vol sur le vaisseau de Roger. Sa forme volante l'a paradoxalement sauvé d'innombrables situations absurdes." },
  { id:12, name:'Bari Bari no Mi',         type:'Paramecia',rarity:'rare',       user:'Bartolomeo',              emoji:'🛡️', power:72, colors:['#14532d','#052e16'], classified:false, spoiler:false,
    desc:"Crée des barrières indestructibles avec les doigts croisés.",
    tags:['Défense','Supernovae','Dressrosa'],
    lore:"Bartolomeo «le Cannibale», grand fan des Chapeaux de Paille, peut créer des barrières arrêtant des géants et des Logia puissants. Elles servent aussi de trampolines offensifs." },
  // ZOAN
  { id:13, name:'Zo Zo no Mi — Mammouth', type:'Zoan',     rarity:'epique',     user:'Jack «la Sécheresse»',    emoji:'🦣', power:85, colors:['#7c2d12','#431407'], classified:false, spoiler:false,
    desc:"Transformation en mammouth antédiluvien. Force brute inégalée, régénération rapide.",
    tags:['Ancien Zoan','Beast Pirates','Force'],
    lore:"Jack est l'un des trois All-Stars des Pirates aux Cents Bêtes. Son mammouth préhistorique lui confère une résistance terrifiante — il a tenu seul contre deux amiraux pendant des heures." },
  { id:14, name:"Ryu Ryu no Mi — Ptéranodon",type:'Zoan',  rarity:'epique',     user:"King «l'Ambition»",       emoji:'🦕', power:90, colors:['#292524','#1c1917'], classified:false, spoiler:false,
    desc:"Transformation en ptérosaure antique de feu. Puissance brute et vol supersonique.",
    tags:['Ancien Zoan','All-Star','Lunaria'],
    lore:"King est un Lunarian — race quasi-éteinte. Corps naturellement en feu + transformation préhistorique = l'un des guerriers les plus résistants jamais affrontés par les Chapeaux de Paille." },
  // MYTHIQUE
  { id:15, name:'Inu Inu no Mi — Kyūbi',  type:'Zoan',     rarity:'mythique',   user:'Catarina Devon',          emoji:'🦊', power:88, colors:['#7c2d12','#431407'], classified:false, spoiler:false,
    desc:"Transformation en renard à neuf queues légendaire. Copie parfaite de toute apparence.",
    tags:['Mythique','Barbe Noire','Espion'],
    lore:"Devon, capitaine parmi les Dix Titres de Barbe Noire, peut imiter parfaitement la forme de n'importe qui — le maître espion absolu de la flotte la plus dangereuse du monde." },
  { id:16, name:'Hito Hito no Mi — Nika', type:'Zoan',     rarity:'mythique',   user:'Monkey D. Luffy',         emoji:'☀️', power:100,colors:['#7f1d1d','#450a0a'], classified:false, spoiler:true,
    desc:"Le fruit le plus puissant de l'histoire. Le Dieu du Soleil Nika. Éveil : Gear 5.",
    tags:['Gear 5','Dieu du Soleil','Joyboy'],
    lore:"Classifié sous le nom «Gomu Gomu no Mi» pendant des siècles. À l'Éveil, Luffy incarne Nika — le Dieu du Soleil — et transforme la réalité elle-même comme du caoutchouc. Son rire libère tout." },
  { id:17, name:'Tori Tori no Mi — Phénix',type:'Zoan',    rarity:'mythique',   user:'Marco',                   emoji:'🦅', power:91, colors:['#1e3a5f','#0f2040'], classified:false, spoiler:false,
    desc:"Transformation en phénix légendaire. Régénération infinie par flammes bleues.",
    tags:['Phénix','Barbe Blanche','Flotte'],
    lore:"Marco peut régénérer indéfiniment grâce aux flammes bleues de son phénix, qui guérissent aussi les alliés proches. Son corps ne peut être détruit tant qu'il reste de la vigueur en lui." },
  { id:18, name:'Hebi Hebi no Mi — Orochi',type:'Zoan',    rarity:'mythique',   user:'Kurozumi Orochi',         emoji:'🐉', power:79, colors:['#14532d','#052e16'], classified:false, spoiler:false,
    desc:"Dragon à huit têtes de la mythologie japonaise. Chaque tête est une conscience distincte.",
    tags:['Mythique','Wano','Shogun'],
    lore:"L'ancien Shogun de Wano se transforme en hydre à huit têtes. Même tranché, il régénère chaque tête individuellement — le rendant quasi-immortel tant qu'une seule subsiste." },
  { id:19, name:'Uo Uo no Mi — Seiryū',   type:'Zoan',     rarity:'mythique',   user:'Kaidou des Cents Bêtes',  emoji:'🐲', power:98, colors:['#1e3a5f','#0f2040'], classified:false, spoiler:false,
    desc:"Dragon céleste azure légendaire. L'être vivant le plus fort du monde.",
    tags:['Dragon','Yonko','Onigashima'],
    lore:"Kaido a survécu à toutes les tentatives d'exécution de la Marine. Son dragon vole, crache des flammes et déclenche des tornades. Son seul vrai rival : Monkey D. Luffy en Gear 5." },
  // CLASSIFIÉ
  { id:20, name:'???', type:'???', rarity:'classifie', user:'Im-sama',   emoji:'👁️', power:0, colors:['#450a0a','#0d0007'], classified:true, spoiler:false,
    desc:"Dossier inaccessible — Niveau d'autorisation 5 requis.", tags:['CLASSIFIÉ','Gouvernement Mondial','Im-sama'],
    lore:"Classifié." },
  { id:21, name:'???', type:'???', rarity:'classifie', user:'Inconnu',   emoji:'⚠️', power:0, colors:['#450a0a','#0d0007'], classified:true, spoiler:false,
    desc:"Fruit détecté par le réseau de renseignement. Nature et localisation : CLASSIFIÉ.", tags:['CLASSIFIÉ','Niveau 5','Alerte Rouge'],
    lore:"Classifié." },
]
...
function ClassifiedOverlay() {
  return (
    <div style={{ position:'absolute',inset:0,background:'rgba(3,3,3,0.9)',zIndex:10,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',gap:10 }}>
      ...
      <div style={{ fontFamily:'var(--font-ui,Rajdhani,sans-serif)',fontSize:10,fontWeight:700,letterSpacing:'0.22em',color:'#9F1239',textTransform:'uppercase',zIndex:12 }}>CLASSIFIÉ — NIVEAU 5</div>
    </div>
  )
}
...
function FruitCard({ fruit, index, spoiler, onClick }) {
  ...
  const tm = TM[fruit.type]  || { color:'#666666', glow:'rgba(102,102,102,0.2)' }
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      whileHover={{ y:-6, scale:1.015, boxShadow:`0 0 28px ${rm.glow},0 0 70px ${rm.glow.replace(/[\d.]+\)$/,'0.08)')},0 24px 60px rgba(0,0,0,0.6)` }}
      style={{
        background:'#0A0A0A', border:`1px solid ${rm.color}`,
    ...
    >
      ...
      <div style={{ position:'relative',height:162,display:'flex',alignItems:'center',justifyContent:'center',overflow:'hidden' }}>
        ...
        <div style={{ fontSize:'3.2rem',position:'relative',zIndex:2,filter:`drop-shadow(0 0 18px ${rm.color})`,transition:'transform 0.4s,filter 0.4s' }}>
          {fruit.emoji}
        </div>
        <HoloOverlay />
      ...
      <div style={{ padding:'14px 16px 18px',flex:1,display:'flex',flexDirection:'column',gap:8,background:`linear-gradient(180deg,${rm.bg} 0%,transparent 100%)` }}>
        <h3 style={{ fontFamily:'Cinzel,serif',fontSize:14,fontWeight:700,color:blur?'transparent':'#EBEBEB',textShadow:blur?'0 0 12px #EBEBEB':'none',letterSpacing:'0.03em',margin:0,lineHeight:1.3 }}>
          {fruit.name}
        </h3>
        ...
        >
          {fruit.classified ? <><Lock size={11}/> ACCÈS REFUSÉ</> : <><FolderOpen size={11}/> OUVRIR LE DOSSIER</>}
        </motion.button>
      </div>
    </motion.div>
  )
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ width:'100%',maxWidth:680,maxHeight:'90vh',overflowY:'auto',background:'#0F0F0F',border:`1px solid ${rm.color}44`,borderRadius:10,boxShadow:`0 0 60px ${rm.glow.replace(/[\d.]+\)$/,'0.22)')},0 0 120px rgba(0,0,0,0.8)` }}
      >
        {fruit.classified ? (
          ...
          <>
            ...
            <div style={{ position:'relative',height:220,overflow:'hidden',background:`radial-gradient(ellipse at 50% 80%,${fruit.colors[0]}66 0%,${fruit.colors[1]}44 50%,#030303 100%)` }}>
              ...
              <button onClick={onClose} style={{ position:'absolute',top:12,right:90,padding:'6px 10px',borderRadius:6,background:'rgba(0,0,0,0.5)',border:'1px solid #1A1A1A',color:'#555',cursor:'pointer',display:'flex',alignItems:'center' }}><X size={14}/></button>
            </div>
            ...
            <div style={{ padding:'24px 28px 28px',display:'flex',flexDirection:'column',gap:20 }}>
              ...
              <div style={{ display:'flex',gap:12,paddingTop:4 }}>
                <motion.button whileHover={{ scale:1.03 }} whileTap={{ scale:0.97 }} style={{ flex:1,fontFamily:'Rajdhani,sans-serif',fontSize:12,fontWeight:700,letterSpacing:'0.15em',textTransform:'uppercase',padding:'10px 0',borderRadius:3,border:`1px solid ${rm.color}`,color:rm.color,background:'rgba(0,0,0,0.4)',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',gap:8 }}>
                  <Star size={11}/> AJOUTER AUX FAVORIS
                </motion.button>
...
function FilterTab({ label, icon:Icon, value, active, color, glow, onClick }) {
  return (
    <motion.button
      onClick={onClick}
      whileTap={{ scale:0.95 }}
...
export default function DevilFruitPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (search) {
      ...
      list = list.filter(f => f.name.toLowerCase().includes(q) || f.user.toLowerCase().includes(q) || f.tags.some(t => t.toLowerCase().includes(q)))
    }
  ...
  const FILTERS = [
    ...
    { value:'zoan',       label:'Zoan',        icon:PawPrint, color:'#F97316', glow:'rgba(249,115,22,0.3)'  },
  ...
  return (
    <div style={{ minHeight:'100vh', background:C.void, position:'relative', fontFamily:'Inter,sans-serif' }}>
      {/* Poneglyph bg */}
      ...
      <div style={{ position:'relative',zIndex:2,padding:'48px 48px 32px',textAlign:'center',borderBottom:'1px solid #111' }}>
        ...
        <div style={{ display:'flex',alignItems:'center',justifyContent:'center',gap:14,marginTop:16,flexWrap:'wrap' }}>
          {[
            { label:'Fruits indexés',  value:FRUITS.length,                              color:'#EAB308' },
            { label:'Fruits classifiés',value:FRUITS.filter(f=>f.classified).length,     color:'#9F1239' },
            { label:'Mythiques',        value:FRUITS.filter(f=>f.rarity==='mythique').length, color:'#A855F7' },
          ].map(s => (
      ...
      <div style={{ position:'sticky',top:0,zIndex:100,background:'rgba(3,3,3,0.92)',backdropFilter:'blur(20px)',borderBottom:'1px solid #111',padding:'12px 32px',display:'flex',flexDirection:'column',gap:10 }}>
        <div style={{ display:'flex',alignItems:'center',gap:10,flexWrap:'wrap' }}>
          ...
          <div style={{ display:'flex',border:'1px solid #1A1A1A',borderRadius:4,overflow:'hidden' }}>
            {[{v:'grid',I:Grid2X2},{v:'list',I:List},{v:'compact',I:LayoutGrid}].map(({v,I})=>(
          ...
          <button onClick={()=>setSpoiler(s=>!s)} style={{ display:'flex',alignItems:'center',gap:8,fontFamily:'Rajdhani,sans-serif',fontSize:11,fontWeight:700,letterSpacing:'0.12em',textTransform:'uppercase',padding:'6px 14px',borderRadius:4,border:`1px solid ${spoiler?'rgba(234,179,8,0.35)':'#1A1A1A'}`,color:spoiler?'#EAB308':'#555',background:'transparent',cursor:'pointer',transition:'all 0.25s' }}>
            {spoiler ? <EyeOff size={12}/> : <Eye size={12}/>}
            Spoilers
      ...
      <div style={{ position:'relative',zIndex:2,padding:'32px 32px 80px' }}>
        ...
        {filtered.length === 0 ? (
          <div style={{ display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'80px 0',gap:16 }}>
            ...
            <p style={{ fontFamily:'Rajdhani,sans-serif',fontSize:12,color:'#1A1A1A',letterSpacing:'0.15em',margin:0 }}>MODIFIEZ VOS FILTRES</p>
          </div>
        ) : (
          <div style={{ display:'grid',gridTemplateColumns:cols,gap:20 }}>
            <AnimatePresence mode="popLayout">
              {filtered.map((fruit,i) => (
                <FruitCard key={fruit.id} fruit={fruit} index={i} spoiler={spoiler} onClick={()=>setModal(fruit)}/>
              ))}
            </AnimatePresence>
          </div>
        )}
