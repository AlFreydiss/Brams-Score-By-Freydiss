...
export const ANIMES = [
  {
    ...
    color: '#e0524a',
    colorDark: '#7a1f1a',
    coverImage: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx21-ELSYx3yMPcKM.jpg',
  ...
  },
  {
    ...
    color: '#5ec8e0',
    colorDark: '#16384a',
    coverImage: 'https://pub-d5e23a54185c409aba2673d9a21d2b1d.r2.dev/anime/covers/bubble.jpg',
    coverPosition: 'center center',
  ...
  },
  {
    ...
    color: '#8e44ad',
    colorDark: '#3d0f5a',
    coverImage: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx20789-Ma5ouSYPkru9.jpg',
    coverPosition: 'center top',
  ...
  },
  {
    ...
    color: '#f57f17',
    colorDark: '#5c2e00',
    coverImage: 'https://pub-d5e23a54185c409aba2673d9a21d2b1d.r2.dev/anime/covers/dbs.jpg',
    coverPosition: 'center center',
  ...
  },
  {
    ...
    subtitle: 'Shigatsu wa Kimi no Uso',
    emoji: '🎹',
    color: '#ff6f9c',
    colorDark: '#5f2540',
  ...
  },
  {
    ...
    stats: [
      { label: 'Épisodes', value: '24 + film' },
      { label: 'Studio', value: 'Tezuka Prod.' },
      { label: 'Statut', value: 'Disponible' },
    ],
    action: '▶ Regarder',
    badge: 'NOUVEAU',
  ...
  },
  {
    ...
    subtitle: 'Kaguya-sama wa Kokurasetai',
    emoji: '🏹',
    color: '#ef4565',
    colorDark: '#5c1a28',
    coverImage: 'https://pub-d5e23a54185c409aba2673d9a21d2b1d.r2.dev/anime/kaguya/cover.jpg',
    coverPosition: 'center top',
    genres: ['Comédie', 'Romance', 'Psychologique'],
    description: "Kaguya et Shirogane, les deux génies du conseil des élèves, s'aiment en secret — mais avouer, c'est perdre. Chaque conversation devient une bataille psychologique hilarante où l'orgueil fait rage.",
    stats: [
      { label: 'Épisodes', value: '37 + Film' },
      { label: 'Studio', value: 'A-1 Pictures' },
      { label: 'Statut', value: 'Disponible' },
    ],
    action: '▶ Regarder',
  ...
  },
  {
    ...
    color: '#00d4ff',
    colorDark: '#003d52',
    coverImage: 'https://pub-d5e23a54185c409aba2673d9a21d2b1d.r2.dev/anime/covers/vivy.jpg',
    coverPosition: 'center center',
  ...
  },
  {
    ...
    color: '#14b8a6',
    colorDark: '#064e46',
    coverImage: 'https://pub-d5e23a54185c409aba2673d9a21d2b1d.r2.dev/anime/carole-tuesday-hls/S01E003/thumb.jpg',
    coverPosition: 'center center',
  ...
  },
  {
    ...
    color: '#ec4899',
    colorDark: '#831843',
    coverImage: 'https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/nx103139-2TfvRyGTE1qp.jpg',
    coverPosition: 'center center',
              ...
              <div style={{ maxWidth:1680, margin:'0 auto 18px', padding:'0 32px' }}>
                <div key={feat.id} style={{ position:'relative', borderRadius:24, overflow:'hidden', minHeight:'clamp(380px, 52vh, 540px)', display:'flex', alignItems:'stretch', border:'1px solid rgba(255,255,255,0.08)', boxShadow:'0 24px 70px rgba(0,0,0,0.5)', animation:'ahHeroFade .6s cubic-bezier(.23,1,.32,1)' }}>
                  ...
                  <div style={{ position:'relative', zIndex:2, padding:'clamp(32px,5vw,60px) clamp(28px,5vw,64px)', maxWidth:720, display:'flex', flexDirection:'column', justifyContent:'center' }}>
                    ...
                    <h1 style={{ fontFamily:"'Pirata One', cursive", margin:0, fontSize:'clamp(40px, 5.5vw, 74px)', fontWeight:900, color:'#fff', lineHeight:1.0, letterSpacing:'-.01em', textShadow:'0 4px 30px rgba(0,0,0,0.75)' }}>{feat.title}</h1>
                    ...
                    <p style={{ margin:0, fontSize:15, color:'rgba(255,255,255,0.68)', lineHeight:1.65, maxWidth:560, display:'-webkit-box', WebkitLineClamp:3, WebkitBoxOrient:'vertical', overflow:'hidden' }}>{feat.description}</p>
                  ...
                  {/* Flèches de navigation façon Crunchyroll */}
                  {heroPicks.length > 1 && ['prev', 'next'].map(dir => (
                    <button key={dir} aria-label={dir === 'prev' ? 'Précédent' : 'Suivant'}
                      onClick={() => setHeroIdx(i => dir === 'prev' ? i + heroPicks.length - 1 : i + 1)}
                      style={{ position:'absolute', top:'50%', [dir === 'prev' ? 'left' : 'right']:18, transform:'translateY(-50%)', zIndex:3, width:46, height:46, borderRadius:'50%', cursor:'pointer', display:'grid', placeItems:'center', fontSize:22, color:'#fff', background:'rgba(8,9,14,0.5)', border:'1px solid rgba(255,255,255,0.18)', backdropFilter:'blur(6px)', transition:'background .2s, transform .2s' }}
                      onMouseEnter={e => { e.currentTarget.style.background='rgba(8,9,14,0.8)'; e.currentTarget.style.transform='translateY(-50%) scale(1.08)' }}
                      onMouseLeave={e => { e.currentTarget.style.background='rgba(8,9,14,0.5)'; e.currentTarget.style.transform='translateY(-50%)' }}>
                      {dir === 'prev' ? '‹' : '›'}
                    </button>
                  ))}
