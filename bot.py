...
_VINN_PING_HYPE = [
    "🔔 wesh on parle de VINN là",
    "👀 VINN dans le chat frérot",
    "📣 VINN a été appelée gros",
    "✨ mention de VINN détectée poto",
    "💬 on cause de VINN ici wallah",
]
...
_FREYDISS_PING_HYPE = [
    "wesh t'as ping **Al Freydiss** là 😳 c'est le boss du terrain, fais gaffe frérot 👑",
    "oh le sang t'as tag **Freydiss** 💀 t'as intérêt d'avoir une bonne raison wallah",
    "ping sur le daron du serveur ?? j'espère c'est important gros 😤👑",
    "t'as invoqué le patron là 🫡 lui c'est pas n'importe qui poto",
    "wallah t'as tag le roi 😭 respect l'audace frérot 👑",
    "on ping pas **Freydiss** comme ça gros, c'est le boss ici 💎",
    "le boss a été mentionné, tout le monde se calme dans le bât' 🫡",
    "t'as ping **Al Freydiss** 💀 le serveur entier te regarde là frérot",
    "tag sur le patron détecté 📡 j'espère t'es carré dans tes baskets gros",
    "frérot t'as ping l'homme le plus solide du serveur, oklm 👑🐐",
    "tu viens de ping le daron de la tess, réalise deux secondes 😭👑",
    "🔔 notif pour le fondateur. Tout le bât' s'arrête, on attend. 👑",
]

# Quand quelqu'un mentionne Freydiss (éloge)
_FREYDISS_HYPE = [
    "**Freydiss** ?? le boss du quartier, y'a R à dire 🐐",
    "on parle du daron du serveur là frérot 🔥",
    "**Freydiss** c'est le sang, il a tout build ici wallah 🫡",
    "wallah c'est le patron, respect obligatoire 👑",
    "le GOAT de la tess 🐐 y'a pas débat gros",
    "gros c'est **Freydiss**, le mec a monté le serveur à la force du poignet 💪",
    "trkl frérot, c'est le chef 💅",
    "**Freydiss** c'est le Gol D. Roger du game, tout le monde court après son trésor 💎",
    "tu parles du seul bonhomme qui ban et bless en même temps 😭👑",
    "**Freydiss** a fondé ce serveur avant même que t'aies le wifi frérot 🐐",
    "**Al Freydiss ツ** ?? le bg du bât' en personne 👑",
    "**Freydiss** — fondateur, Yonkou, légende du quartier. Dans cet ordre. ☠️",
]

# Quand Freydiss parle lui-même
_FREYDISS_SELF_HYPE = [
    "wesh le boss a parlé, silence dans le bât' 🫡",
    "le daron est dans le chat, rangez-vous les kheys 👑",
    "oh le sang, **Al Freydiss** a pris la parole, prenez des notes 📝",
    "le patron est en ligne wallah, le serveur peut respirer 😮‍💨",
    "quand **Freydiss** écrit, même Discord se met droit frérot 💀",
    "le roi du quartier vient de parler, oklm 👑",
    "**Al Freydiss ツ** dans le chat c'est comme Shanks qui pose le pied sur le terrain — tout le monde se calme ⚔️",
    "gros le fondateur a tapé un message, encadrez-moi ça 🖼️",
    "mon daron, mon créateur, la raison pour laquelle je boot 🤖👑",
    "le capitaine parle, l'équipage écoute — c'est le code de la street 🏴‍☠️",
    "wallah même son 'ok' c'est de la poésie 👏",
    "la légende est en ligne frérot. Je répète : LA LÉGENDE EST EN LIGNE 🔥",
    "le Yonkou du serveur a parlé, les autres retournez en vocal 🎙️",
    "présence du boss confirmée, tout le monde carré 🫡",
    "Luffy cherchait One Piece, nous on a **Freydiss**. C'est mieux gros. ☠️",
    "**Freydiss** a tapé un message et j'ai failli crash tellement c'était lourd 🥺💎",
]

# Quand on parle mal de Freydiss
_FREYDISS_DEFENSE = [
    "oh frérot t'as PAS osé parler comme ça de **Freydiss** ?? sors du serveur wallah 💀",
    "wesh c'est quoi ces manières ?? **Freydiss** a tout build ici et toi t'ouvres ta bouche ?? 😤",
    "gros réfléchis deux secondes : **Freydiss** = le daron du serveur. Toi = R. Recalcule. 😭",
    "j'hallucine, t'as le seum ou quoi ?? on parle pas comme ça du boss 💢",
    "ton avis sur **Freydiss** → poubelle direct, merci ciao 👋",
    "tu parles mal du patron ET tu restes sur SON serveur ?? t'es un ouf toi 💀",
    "wallah si je pouvais ban tu serais déjà dehors frérot 😤🤖",
    "le respect gros, ça se perd... **Freydiss** mérite pas ça, corrige-toi 👑",
    "qui t'a autorisé à parler du créateur comme ça ?? les nerfs frérot 😭",
    "🤡 gros courage de manquer de respect à **Freydiss** sur SON terrain. Chapeau l'artiste.",
    "Zoro et Sanji s'embrouillent mais ils respectent leur capitaine. Prends-en de la graine poto. 🏴‍☠️",
    "c'est **Al Freydiss ツ** dont tu parles là. Le boss. Le roi. Fais gaffe à ta bouche frérot 💢",
    "je vais crari pas avoir lu ça pour ton bien 😇 mais **Freydiss** mérite mieux wallah 👑",
]

# Correction de faute d'orthographe du prénom
_FREYDISS_TYPO_CORR = [
    "c'est **Freydiss** frérot, pas `{wrong}` 💀 t'es sérieux là ??",
    "wesh `{wrong}` ?? le nom c'est **Freydiss**. F-R-E-Y-D-I-S-S. Relis-toi gros 😤",
    "`{wrong}` c'est qui ?! le boss s'appelle **Freydiss** ✍️",
    "t'as écrit `{wrong}` crari c'était bon 💀 c'est **Freydiss** le sang",
    "oh non... `{wrong}` ?? on dit **Freydiss** 👑 apprends le nom du daron wallah",
    "petit rappel frérot : **FREYDISS**. Pas `{wrong}`. Reprends-toi 😭",
    "correction auto : `{wrong}` → **Freydiss**. De rien gros. 💅",
    "le clavier c'est pas fait pour écrire `{wrong}` 💀 c'est **Freydiss** poto, note-le.",
    "`{wrong}` ?? j'ai eu mal pour lui wallah. C'est **Freydiss**. Respect l'orthographe du roi 👑",
    "`{wrong}` ❌ → **Freydiss** ✅ — encore une faute et je te ban mentalement frérot 🤖",
]
